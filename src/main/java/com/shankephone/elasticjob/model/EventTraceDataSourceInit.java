 ...
 */
@Slf4j
public final class EventTraceDataSourceInit {
    
    @Getter(AccessLevel.PROTECTED)
    private EventTraceDataSource eventTraceDataSourceConfiguration;
    
    public EventTraceDataSourceInit(final EventTraceDataSource eventTraceDataSourceConfiguration) {
