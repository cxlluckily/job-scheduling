...
public final class SessionEventTraceDataSourceConfiguration {
    ...
    private static EventTraceDataSource eventTraceDataSourceConfiguration;
     ...
     * @return 事件追踪数据源配置
     */
    public static EventTraceDataSource getEventTraceDataSourceConfiguration() {
     ...
     */
    public static void setDataSourceConfiguration(final EventTraceDataSource eventTraceDataSourceConfiguration) {
